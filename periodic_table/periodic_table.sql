...
--
-- Name: properties properties_boiling_point_celsius_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT properties_boiling_point_celsius_key UNIQUE (boiling_point_celsius);


--
-- Name: properties properties_melting_point_celsius_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT properties_melting_point_celsius_key UNIQUE (melting_point_celsius);
